...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_BURN), MP_ROM_PTR(&pin_PA15)},

    {MP_ROM_QSTR(MP_QSTR_SENSE_THERM), MP_ROM_PTR(&pin_PA02)},
    ...
    {MP_ROM_QSTR(MP_QSTR_ENAB_RF), MP_ROM_PTR(&pin_PA19)},
    ...
    {MP_ROM_QSTR(MP_QSTR_ENAB_THERM), MP_ROM_PTR(&pin_PB06)},

    {MP_ROM_QSTR(MP_QSTR_ENAB_GPS), MP_ROM_PTR(&pin_PB01)},
    {MP_ROM_QSTR(MP_QSTR_TX), MP_ROM_PTR(&pin_PB02)},
    {MP_ROM_QSTR(MP_QSTR_RX), MP_ROM_PTR(&pin_PB03)},

    {MP_ROM_QSTR(MP_QSTR_ENAB_CORAL), MP_ROM_PTR(&pin_PB07)},
    {MP_ROM_QSTR(MP_QSTR_RST_CORAL), MP_ROM_PTR(&pin_PB09)},
